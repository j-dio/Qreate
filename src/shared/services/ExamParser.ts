/**
 * Shared Exam Parser Service
 *
 * Parses AI-generated exam text into structured question objects.
 * This is a shared service that can be used in both main and renderer processes.
 *
 * Expected Format (from AI providers):
 * ```
...
import type { GeneratedQuestion } from '../types/exam'
...
export class ExamParser {
   ...
   *
   * @param examText - Raw text from AI
